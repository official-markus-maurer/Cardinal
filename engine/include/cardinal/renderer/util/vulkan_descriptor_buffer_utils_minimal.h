...
bool vk_descriptor_buffer_write_storage_buffer(void* vulkan_state,
...
bool vk_descriptor_buffer_write_uniform_buffer(void* vulkan_state,
                                               void* descriptor_buffer,
                                               VkDeviceSize offset,
                                               VkBuffer buffer,
                                               VkDeviceSize buffer_offset,
...
bool vk_descriptor_buffer_write_combined_image_sampler(void* vulkan_state,
                                                       void* descriptor_buffer,
                                                       VkDeviceSize offset,
