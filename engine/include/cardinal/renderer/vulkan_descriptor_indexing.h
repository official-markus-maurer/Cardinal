...
typedef struct BindlessTexturePool {
  ...
  VkDescriptorSetLayout
      descriptor_layout; /**< Descriptor set layout for bindless textures */
 ...
 */
void vk_bindless_texture_free(BindlessTexturePool *pool,
...
bool vk_bindless_texture_update_data(BindlessTexturePool *pool,
                                     uint32_t texture_index, const void *data,
 ...
 */
VkDescriptorSet
vk_bindless_texture_get_descriptor_set(const BindlessTexturePool *pool);
 ...
 */
VkDescriptorSetLayout
vk_bindless_texture_get_layout(const BindlessTexturePool *pool);
 ...
 * @param variable_binding_index Index of the binding with variable descriptor
 * count
 * @param max_variable_count Maximum number of descriptors for the variable
 * binding
 * @param out_layout Pointer to store the created layout
 * @return true on success, false on failure
 */
bool vk_create_variable_descriptor_layout(
    VkDevice device, uint32_t binding_count,
    const VkDescriptorSetLayoutBinding *bindings,
    uint32_t variable_binding_index, uint32_t max_variable_count,
