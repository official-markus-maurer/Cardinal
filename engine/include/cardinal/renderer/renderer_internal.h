...
VkCommandBuffer
cardinal_renderer_internal_current_cmd(CardinalRenderer *renderer,
                                       uint32_t image_index);
VkDevice cardinal_renderer_internal_device(CardinalRenderer *renderer);
VkPhysicalDevice
cardinal_renderer_internal_physical_device(CardinalRenderer *renderer);
VkQueue cardinal_renderer_internal_graphics_queue(CardinalRenderer *renderer);
uint32_t
cardinal_renderer_internal_graphics_queue_family(CardinalRenderer *renderer);
VkInstance cardinal_renderer_internal_instance(CardinalRenderer *renderer);
uint32_t
cardinal_renderer_internal_swapchain_image_count(CardinalRenderer *renderer);
VkFormat
cardinal_renderer_internal_swapchain_format(CardinalRenderer *renderer);
VkFormat cardinal_renderer_internal_depth_format(CardinalRenderer *renderer);
VkExtent2D
cardinal_renderer_internal_swapchain_extent(CardinalRenderer *renderer);
