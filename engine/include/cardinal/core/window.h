 ...
 * 
 * This module provides a cross-platform window abstraction layer built on top of GLFW.
 * It handles window creation, event polling, and provides access to native window handles
 * for graphics API surface creation.
 * 
...
/** @brief Forward declaration of GLFWwindow to avoid including GLFW in public header */
struct GLFWwindow;
