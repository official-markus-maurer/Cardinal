...
/**
 * @file transform.h
 * @brief Transform utility functions for matrix operations and coordinate space
 * conversions.
 */
...
/**
 * @brief Creates a transformation matrix from translation, rotation
 * (quaternion), and scale.
 * @param translation Translation vector (3 floats), can be NULL for no
 * translation.
 * @param rotation Rotation quaternion (4 floats: x, y, z, w), can be NULL for
 * no rotation.
 ...
 */
void cardinal_matrix_from_trs(const float *translation, const float *rotation,
                              const float *scale, float *matrix);

/**
 * @brief Decomposes a transformation matrix into translation, rotation, and
 * scale components.
 * @param matrix Input 4x4 transformation matrix (16 floats, column-major).
 * @param translation Output translation vector (3 floats), can be NULL if not
 * needed.
 * @param rotation Output rotation quaternion (4 floats: x, y, z, w), can be
 * NULL if not needed.
 ...
 */
bool cardinal_matrix_decompose(const float *matrix, float *translation,
 ...
 */
void cardinal_transform_point(const float *matrix, const float *point,
                              float *result);
 ...
 */
void cardinal_transform_vector(const float *matrix, const float *vector,
                               float *result);
 ...
 */
void cardinal_transform_normal(const float *matrix, const float *normal,
                               float *result);
 ...
 */
void cardinal_quaternion_multiply(const float *a, const float *b,
                                  float *result);
 ...
 * @param quaternion Output quaternion (4 floats: x, y, z, w).
 */
void cardinal_quaternion_from_euler(float pitch, float yaw, float roll,
                                    float *quaternion);
 ...
 */
void cardinal_quaternion_to_euler(const float *quaternion, float *pitch,
 ...
 * @param matrix Input/output 4x4 transformation matrix (16 floats,
 * column-major).
