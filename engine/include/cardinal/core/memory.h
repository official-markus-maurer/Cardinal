 ...
 */
typedef struct {
    CardinalMemoryStats categories[CARDINAL_MEMORY_CATEGORY_MAX]; /**< Per-category stats */
 ...
 * @param default_linear_capacity Initial capacity for the default linear allocator
 */
