 ...
 * 
 * This module provides a comprehensive logging system with multiple severity levels,
 * runtime level filtering, and convenient macros for easy use throughout the engine.
 * The logging system supports both debug and release builds with different behavior.
 * 
 * Features:
 ...
 * @return Corresponding CardinalLogLevel enum value, or CARDINAL_LOG_LEVEL_INFO if invalid
 */
