...
pub const animation = @import("assets/animation.zig");
pub const animation_controller = @import("assets/animation_controller.zig");
...
pub const nif_loader = @import("assets/nif_loader.zig");
