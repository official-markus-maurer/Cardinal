...
void imgui_bridge_pop_style_var(int count) { ImGui::PopStyleVar(count); }
...
void imgui_bridge_style_colors_cardinal(void) {
  ...
  // Modern Engine Styling (Cardinal Theme)
  ...
  // Cardinal Red Accent: #C41E3A -> (0.768f, 0.117f, 0.227f, 1.0f)
  // Deep Slate Background: #1E1E1E -> (0.117f, 0.117f, 0.117f, 1.0f)
  // Lighter Slate: #252526 -> (0.145f, 0.145f, 0.149f, 1.0f)
  // Even Lighter Slate: #2D2D30 -> (0.176f, 0.176f, 0.188f, 1.0f)

  colors[ImGuiCol_Text]                   = ImVec4(0.90f, 0.90f, 0.90f, 1.00f);
  colors[ImGuiCol_TextDisabled]           = ImVec4(0.60f, 0.60f, 0.60f, 1.00f);
  colors[ImGuiCol_WindowBg]               = ImVec4(0.117f, 0.117f, 0.117f, 1.00f);
  colors[ImGuiCol_ChildBg]                = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
  colors[ImGuiCol_PopupBg]                = ImVec4(0.145f, 0.145f, 0.149f, 0.98f);
  colors[ImGuiCol_Border]                 = ImVec4(0.25f, 0.25f, 0.27f, 0.50f);
  colors[ImGuiCol_BorderShadow]           = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
  colors[ImGuiCol_FrameBg]                = ImVec4(0.176f, 0.176f, 0.188f, 1.00f);
  ...
  colors[ImGuiCol_TitleBg]                = ImVec4(0.117f, 0.117f, 0.117f, 1.00f);
  colors[ImGuiCol_TitleBgActive]          = ImVec4(0.117f, 0.117f, 0.117f, 1.00f);
...
void imgui_bridge_set_display_scale(float scale) {
  // Reset style to ensure consistent scaling
  imgui_bridge_style_colors_cardinal();
...
void imgui_bridge_impl_glfw_shutdown(void) { ImGui_ImplGlfw_Shutdown(); }

void imgui_bridge_impl_glfw_new_frame(void) { ImGui_ImplGlfw_NewFrame(); }
...
bool imgui_bridge_impl_vulkan_init(ImGuiBridgeVulkanInitInfo *info) {
  ...
  init_info.PipelineInfoMain.MSAASamples =
      (VkSampleCountFlagBits)info->msaa_samples;
  ...
  if (info->use_dynamic_rendering) {
    ...
    init_info.PipelineInfoMain.PipelineRenderingCreateInfo
        .depthAttachmentFormat = (VkFormat)info->depth_attachment_format;
    init_info.PipelineInfoMain.PipelineRenderingCreateInfo
...
void imgui_bridge_end(void) { ImGui::End(); }
...
void imgui_bridge_separator(void) { ImGui::Separator(); }
...
void imgui_bridge_end_child(void) { ImGui::EndChild(); }
...
void imgui_bridge_end_menu(void) { ImGui::EndMenu(); }
...
void imgui_bridge_indent(float indent_w) { ImGui::Indent(indent_w); }

void imgui_bridge_unindent(float indent_w) { ImGui::Unindent(indent_w); }
